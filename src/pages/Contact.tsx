            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="bg-card rounded-2xl p-6 shadow-lg border border-border/50">
                  ...
                  <div className="bg-secondary/5 rounded-xl p-4 border border-primary/20">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center gap-4 bg-card rounded-xl p-4 shadow-md border border-border/50 hover:border-primary/50 transition-all group"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <div className="w-12 h-12 rounded-xl bg-secondary group-hover:bg-primary flex items-center justify-center transition-all group-hover:scale-110 shadow-md flex-shrink-0">
                      <Facebook size={24} className="text-white" />
                    </div>
                    <span className="text-base font-medium group-hover:text-primary transition-colors">FakeArab Shawarma Station</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="text-base font-medium group-hover:text-primary transition-colors">@fakearabshawarmastation</span>
                  </a>
                  <a
